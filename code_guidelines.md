...
```
You can perform a shortcut on Android Studio for do this.
[Read this](http://stackoverflow.com/questions/16580171/code-formatting-shortcut-in-android-studio)
...
4. Total Characters of the _Subject Line_ **MUST** be _Less_ than or _Equal_ to **50** Chars Long. (suggested by Github)
...
| :wrench: | `:wrench:`| when configuring environment or anything related to the project
| :fire: | `:fire:` | when **removing code** or files |
| :recycle: | `:recycle:`| when just **renaming or changing for guidelines**
| :ambulance: | `:ambulance:` | when fixing a **bug** |
| :bug: | `:bug:` | when reporting a **bug**|
| :sparkles: | `:sparkles:` | when introducing **New** Features |
| :art: | `:art:` | when improving the **format/structure or just refractor** of the code |
...
## Git flow
![](https://github.com/jeancsanchez/Android-Guidelines-and-Architecture/blob/master/Fluxo%20de%20versionamento%20Git.PNG)
